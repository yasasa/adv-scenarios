...
try:
    ##
    sys.path.append(glob.glob('/home/zidong/Desktop/CARLA_0.9.5/PythonAPI/carla/dist/carla-*%d.%d-%s.egg' % (
...
class LocalPlanner(object):
    ...
    def _init_controller(self, opt_dict):
        ...
        self._sampling_radius = self._target_speed * 1 / 3.6  # 1 seconds horizon   #5.5
        self._min_distance = self._sampling_radius * self.MIN_DISTANCE_PERCENTAGE  # 5.5*0.9=5
        args_lateral_dict = {
            'K_P': 1.95,
            'K_D': 0.01,
            'K_I': 1.4,
        ...
        ##
        print('local planner: current location, ', self._vehicle.get_location())
        ...
        temp = self._current_waypoint.next(self._sampling_radius)[0]
        #self._waypoints_queue.append((self._current_waypoint.next(self._sampling_radius)[0], RoadOption.LANEFOLLOW))
        self._waypoints_queue.append((temp, RoadOption.LANEFOLLOW))
        ####
        print('init way pt: ', temp)
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            ...
            if len(next_waypoints) == 1:
                ...
                if RoadOption.RIGHT in road_options_list:
                    road_option = RoadOption.RIGHT
                elif RoadOption.STRAIGHT in road_options_list:

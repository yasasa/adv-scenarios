...
import sys
try:
    sys.path.append("../carla/dist/carla-0.9.6-py3.6-linux-x86_64.egg")
except IndexError:
    pass
# ==============================================================================
# -- imports -------------------------------------------------------------------
...
PWD = '/home/siyun/CARLA/repo/carla/Dist/CARLA_Shipping_0.9.6-5-g255683a7-dirty/LinuxNoEditor/PythonAPI'
folder = '/PT_CNN_NO_COLOUR'
...
def game_loop(args):
    ...
    try:
        ...
        validate_all = BufferedImageSaver('%s/ep_%d/' % (validate_dir, episode_count),
                               100, 32, 100, 9, 'All')
        saver_car_rotation = BufferedImageSaver('%s/ep_%d/' % (out_dir, episode_count),
                               100, 1, 1, 3, 'Rotation')
        ...
        with world:
            ...
            while True:
                ...
                if ret:
                    ...
                    # images_clean = [clean_img(img_rgb)]
                    ...
                    rot = snapshot.find(world.player.id).get_transform().rotation
                    transform_arr = [rot.pitch, rot.yaw, rot.roll]
                    print(transform_arr)
                    # saver_car_rotation.add_image()
                pygame.display.flip()
